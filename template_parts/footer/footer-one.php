<footer class="footer p-10 bg-base-200 text-base-content">
  <div>
    ...
    <a class="link link-hover" href="/contact">Branding</a> 
    <a class="link link-hover" href="/contact">Design</a> 
    <a class="link link-hover" href="/contact">Marketing</a> 
    <a class="link link-hover" href="/contact">Advertisement</a>
  </div> 
  <div>
  ...
  <span class="footer-title">Tag</span>
      <div class="grid grid-cols-1 gap-3">
        <a class="link link-hover" href="/contact">@tag1</a>
        <a class="link link-hover" href="/contact">@tag2</a>
        <a class="link link-hover" href="/contact">@tag3</a>
        <a class="link link-hover" href="/contact">@tag4</a>
      </div>
  </div>
</footer> 
<footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  ...
  <div class="md:place-self-center md:justify-self-end">
    <div class="grid grid-flow-col gap-4">
      ...
      <a href="/contact"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
    </div>
  </div>
</footer>