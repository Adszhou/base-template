...
<main class="px-4 pb-8 lg:max-w-6xl lg:mx-auto">
  ...
  <ul class="space-y-6">
    ...
    ?>
      ...
      <li class="w-full lg:w-[50rem] list-none flex items-center hover:bg-gray-200 rounded-xl shadow-xl">
        <a class="flex group" href="<?php echo $post_link; ?>">

          <div class="min-w-[9.375rem] min-h-[11rem]">
            <?php if ($first_img) : ?>
              <img class="w-[9.375rem] h-[11rem] object-cover  rounded-xl shadow-xl" src="<?php echo $first_img; ?>" alt="single"/>
            <?php else : ?>
          ...
          <div class="ml-4 lg:ml-8 flex flex-col justify-between">
            <div>
              ...
              <p class="line-clamp-2 text-sm pt-5"><?php echo $post_excerpt; ?></p>
            </div>
            <div class="flex justify-between">
              ...
              <div class="hidden lg:block">
                <span class="text-sm text-gray-400"><?php echo $post_comment_count ?? 0 ?> Comments</span>
                <span class="text-sm text-gray-400"><?php echo $post_views_count ?? 0 ?> Views</span>
                <span class="text-sm text-gray-400"><?php echo $post_like_count ?? 0 ?> Likes</span>
              </div>
            </div>
          </div>
        </a>
